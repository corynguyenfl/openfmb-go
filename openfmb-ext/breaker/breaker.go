...
func DeviceMRID(msg proto.Message) (mrid string, err error) {
	...
	case *breakermodule.BreakerDiscreteControlProfile:
		return profile.Breaker.ConductingEquipment.MRID, nil
	case *breakermodule.BreakerEventProfile:
		return profile.Breaker.ConductingEquipment.MRID, nil
	case *breakermodule.BreakerReadingProfile:
		return profile.Breaker.ConductingEquipment.MRID, nil
	case *breakermodule.BreakerStatusProfile:
		return profile.Breaker.ConductingEquipment.MRID, nil
