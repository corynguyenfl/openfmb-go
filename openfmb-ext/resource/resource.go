...
func DeviceMRID(msg proto.Message) (mrid string, err error) {
	...
	case *resourcemodule.ResourceDiscreteControlProfile:
		return profile.ConductingEquipment.MRID, nil
	case *resourcemodule.ResourceReadingProfile:
		return profile.ConductingEquipment.MRID, nil
	case *resourcemodule.ResourceEventProfile:
		return profile.ConductingEquipment.MRID, nil
	case *resourcemodule.ResourceStatusProfile:
		return profile.ConductingEquipment.MRID, nil
