...
func DeviceMRID(msg proto.Message) (mrid string, err error) {
	...
	case *loadmodule.LoadControlProfile:
		return profile.EnergyConsumer.ConductingEquipment.MRID, nil
	case *loadmodule.LoadEventProfile:
		return profile.EnergyConsumer.ConductingEquipment.MRID, nil
	case *loadmodule.LoadReadingProfile:
		return profile.EnergyConsumer.ConductingEquipment.MRID, nil
	case *loadmodule.LoadStatusProfile:
		return profile.EnergyConsumer.ConductingEquipment.MRID, nil
