...
func DeviceMRID(msg proto.Message) (mrid string, err error) {
	...
	case *essmodule.ESSControlProfile:
		return profile.Ess.ConductingEquipment.MRID, nil
	// case *essmodule.ESSDiscreteControlProfile:
	// 	return profile.Ess.ConductingEquipment.MRID, nil
	case *essmodule.ESSEventProfile:
		return profile.Ess.ConductingEquipment.MRID, nil
	case *essmodule.ESSReadingProfile:
		return profile.Ess.ConductingEquipment.MRID, nil
	case *essmodule.ESSStatusProfile:
		return profile.Ess.ConductingEquipment.MRID, nil
