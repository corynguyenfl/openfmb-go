...
func DeviceMRID(msg proto.Message) (mrid string, err error) {
	...
	case *generationmodule.GenerationControlProfile:
		return profile.GeneratingUnit.ConductingEquipment.MRID, nil
	case *generationmodule.GenerationDiscreteControlProfile:
		return profile.GeneratingUnit.ConductingEquipment.MRID, nil
	case *generationmodule.GenerationReadingProfile:
		return profile.GeneratingUnit.ConductingEquipment.MRID, nil
	case *generationmodule.GenerationEventProfile:
		return profile.GeneratingUnit.ConductingEquipment.MRID, nil
	case *generationmodule.GenerationStatusProfile:
		return profile.GeneratingUnit.ConductingEquipment.MRID, nil
